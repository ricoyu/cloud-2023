...
import com.loserico.cloud.handler.BlockHandlerV3;
...
public class OrderControllerV3 {
	...
	public void init() {
		...
		flowRule.setResource("helloSentinelV3"); //是自己给要保护的资源起的一个名字
	...
	@GetMapping("/v3/findOrderByUserId/{userId}")
	@SentinelResource(value = "helloSentinelV3", blockHandler = "blockHandlerForHelloSentinelV3", blockHandlerClass = BlockHandlerV3.class)
	public Result helloSentinelV3(@PathVariable String userId) {
